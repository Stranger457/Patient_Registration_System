                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    className={`form-input h-8 w-full px-4 py-3 border border-black ${errors.first_name ? 'border-error-500 focus:ring-error-500 focus:border-error-500' : ''}`}
                                    required
                                />
                                {errors.first_name && (
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`form-input h-8 w-full px-4 py-3 border border-black ${errors.last_name ? 'border-error-500 focus:ring-error-500 focus:border-error-500' : ''}`}
                                    required
                                />
                                {errors.last_name && (
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`form-input h-8 w-full px-4 py-3 border border-black ${errors.date_of_birth ? 'border-error-500 focus:ring-error-500 focus:border-error-500' : ''}`}
                                    required
                                />
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`form-input h-8 w-full px-4 py-3 border border-black ${errors.email ? 'border-error-500 focus:ring-error-500 focus:border-error-500' : ''}`}
                                />
                                {errors.email && (
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="form-input h-8 w-full px-4 py-3 border border-black"
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="form-input h-8 w-full px-4 py-3 border border-black"
                                    placeholder="123 Main St or Apartment #"
                                />
                            </div>
                            ...
                            <div className="sm:col-span-2">
                                <label htmlFor="past_medical_history" className="form-label">
                                    Past Medical History <span className="text-error-500">*</span>
                                </label>
                                ...
                                <textarea
                                    ...
                                    onChange={(e) => {
                                        setFormData({ ...formData, past_medical_history: e.target.value });
                                    }}
                                ...
                                {errors.past_medical_history && (
                                    <p className="mt-1 text-sm text-error-600">{errors.past_medical_history}</p>
                                )}
                            </div>
